...
var expectedAssetPaths = []string{
	...
	// OpenCode agents — Divisor personas (6) + Cobalt-Crush (1) + Mx F coach (1) + constitution-check (1) + onboarding (1) + pinkman (1)
	...
	"opencode/agents/onboarding.md",  // Spec 031: Onboarding interview agent (user-owned)
